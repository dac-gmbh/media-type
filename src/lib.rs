...
pub use self::spec::{
    Spec,
    AnySpec, StrictSpec, MimeSpec, HttpSpec,
...
//        Name::new_unchecked(&self.source.as_ref()[..self.slash])
//    }
//
...
//        });
//        Name::new_unchecked(&self.source.as_ref()[self.slash + 1..end])
//    }
//
...
//        self.plus.map(|idx| Name::new_unchecked(&self.source.as_ref()[idx + 1..end]))
//    }
//
...
//
//    fn from_str(_s: &str) -> Result<Mime, Self::Err> {
//        unimplemented!()
//        //TODO
...
//                    let name = Name::new_unchecked(&source.as_ref()[name.0..name.1]);
//                    let value = Value::new_unchecked_with_bool(
//                        &source.as_ref()[value.0..value.1],
//                        name == CHARSET
//                    );
//                    (name, value)
//                })
...
//            $(
//            assert_eq!($id.as_str().to_ascii_lowercase(), $id.as_str());
//            )*
//        }
//    )
//}
